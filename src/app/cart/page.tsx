...
function CartPageContent() {
  ...
  }, [country, stateOrProvince, postalCode, shippingLength, shippingHeight, shippingWeight, shippingWidth]);
  ...
  const canProceedToPayment = isFormComplete && shippingCost !== null && shippingCost > 0 && !isLoadingShipping;
        ...
        <div className="relative flex flex-row w-full md:w-3/4 justify-center items-start">
          <div className="absolute top-0 left-0 z-10 flex flex-col gap-3">
            ...
            <button
              ...
              className="cursor-pointer rounded-lg overflow-hidden border-2 transition-all shadow-md hover:shadow-lg hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              style={{
                borderColor: activeImage === "back" ? "#3b82f6" : "rgba(0, 0, 0, 0.1)",
          ...
          <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl p-6 shadow-lg border border-gray-300">
            <Image
              ...
              width={imgWidth}
              height={imgHeight}
              className="object-contain rounded-lg filter drop-shadow-lg"
            />
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-md">
            ...
            <div className="mb-5 mt-5 leading-relaxed px-4">
              ...
              <div className="grid grid-cols-[auto,1fr] gap-x-4 gap-y-2">
                ...
                <p className="font-semibold text-gray-800">${price.toFixed(2)} CAD</p>
                ...
                <div className="flex items-center gap-2">
                  {isLoadingShipping ? (
                    <>
                      ...
                      <p className="font-semibold text-gray-500 text-sm">Calculating...</p>
                    </>
                  ) : (
                    <p className="font-semibold text-gray-800">
            ...
            <div className="px-4 pb-4">
              ...
              <div className="block">
                <button
                  ...
                  aria-label={canProceedToPayment ? "Proceed to payment" : "Complete shipping form to proceed"}
                >
                  {canProceedToPayment ? (
                    <Image
                      src={StripeIcon}
