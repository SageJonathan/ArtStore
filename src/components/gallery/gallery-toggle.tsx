  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center justify-center text-white px-4 py-2 rounded-lg bg-rose-200 hover:bg-pink-200 focus:outline-none hover:text-black space-x-2"
      >
